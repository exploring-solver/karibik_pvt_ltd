    ...
    <>
      <nav className="">
        <div className=' bg-[#13314C]'>
          ...
          <div className=" flex justify-end text-xs  text-white ">
            ...
            <Link to="/contact-us" className=" hover:text-yellow-400 px-3 py-2 my-2 border-r-[1px] font-semibold">CONTACT US</Link>
      ...
      <div className='text-lg font-semibold text-black bg-zinc-200 pt-3 sticky top-0 z-30'>
        <div className="flex flex-wrap items-start sticky top-0">
          ...
          <Link to="/faqs" className=" hover:text-blue-500 px-3  border-gray-700 my-2 ">FAQ'S</Link>
        </div>
        <div className='flex justify-end sticky top-0'>
          <Link to="/apply-now" className=" bg-yellow-500  hover:bg-[#00E6F6] py-5 pr-6 pl-12 border-l-8 border-gray-700 mt-2 ">APPLY NOW</Link>
        </div>
      </div>
    </>
  );
